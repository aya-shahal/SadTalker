...
wget -nc https://github.com/OpenTalker/SadTalker/releases/dowxnload/v0.0.2-rc/SadTalker_V0.0.2_512.safetensors -O  ./checkpoints/SadTalker_V0.0.2_512.safetensors
